...
def process_grailqa_data():
    # Load the GrailQA test dataset
    test_data_path = PROJECT_ROOT / "data_kg" / "grailqa" / "test_simple.json"
    entities_path = PROJECT_ROOT / "data_kg" / "grailqa" / "entities.txt"
    entities_text_path = PROJECT_ROOT / "data_kg" / "grailqa" / "entities_text.txt"
    ...
    output_dir = PROJECT_ROOT / "data_kg" / "grailqa_search_augmented_initial_entities"
