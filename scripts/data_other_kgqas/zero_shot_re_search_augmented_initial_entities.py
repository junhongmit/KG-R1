...
def improve_question_quality(question):
    """
    Improve question quality for Zero-Shot RE dataset
...
def process_zero_shot_re_data():
    # Load the Zero-shot RE test dataset
    test_data_path = PROJECT_ROOT / "data_kg" / "zero_shot_re" / "test_simple.json"
    entities_path = PROJECT_ROOT / "data_kg" / "zero_shot_re" / "entities.txt"
    entities_text_path = PROJECT_ROOT / "data_kg" / "zero_shot_re" / "entities_text.txt"
    ...
    output_dir = PROJECT_ROOT / "data_kg" / "zero_shot_re_search_augmented_initial_entities"
